                            ...
                            <div className="skill_content_two">
                                <Reveal effect="fadeInUp" duration={700}>
                                    <div className="skill_content_two">
                                        ...
                                        <p>I started my career with Html, Css, Sass, PHP, and Javascript for simple tasks as a web developer, and during some period of working for several projects, 
                                            I felt strong interesting in Javascript frontend frameworks such as React, Redux, Greensock, and TweenMax animation affects. ;)</p>
                                    </div>
                                </Reveal>
                            </div>
